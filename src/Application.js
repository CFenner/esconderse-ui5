...
//	var oModel = new sap.ui.model.json.JSONModel("https://esconderse.de/ajax.php?a=get");
//	sap.ui.xmlview("main").setModel(oModel).placeAt("content");			
...
sap.ui.app.Application.extend("Application", {
	init : function() {
		...
		sap.ui.getCore().setModel(mailModel);//, "mail");
...
//# sourceURL=https://openui5.hana.ondemand.com/test-resources/sap/m/demokit/icon-explorer/Application.js